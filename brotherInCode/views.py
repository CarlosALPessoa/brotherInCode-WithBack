...
def home(request):
    data = {}
    data['tutors'] = Tutores.objects.all()
    return render(request, 'brotherInCode/main2.html', context=data)

def perfilTutor(request):
    data = {}
    data['tutors'] = Tutores.objects.all()
    return render(request, 'brotherInCode/main.html', context=data)

def quemSomos(request):
    return render(request, 'brotherInCode/quem somos.html')

def tutorias(request):
    return render(request, 'brotherInCode/tutorias.html')

def perfil(request):
    return render(request, 'brotherInCode/perfil.html')
